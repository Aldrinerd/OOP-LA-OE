...
fave1 = Favorite_food("Sinigang","Pork","Green pepper","Raddish")
fave2 = Favorite_food("Ginisang Ampalaya","Ground pork","Bitter gourd","Egg")
fave3 = Favorite_food("Pork Steak","Pork","Soy sauce","Onion")
